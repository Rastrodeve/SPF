...
<head>
    ...
    <title>ADMINISTRACIÓN ANTEMORTEM</title>
        ...
        <div class="content-wrapper ">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5 class="m-0 text-dark"><b>ADMINISTRACIÓN ANTEMORTEM</b></h5>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Administrador</li>
                                <li class="breadcrumb-item active">Administración antemortem</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid p-2 pt-3">
                <div class="row mb-2">
                    <div class="col-md-12">
                        <button type="button" class="btn btn-outline-secondary pl-5 pr-5" onclick="get_new()" data-toggle="modal"
                            data-target="#modal">
                            <b>NUEVA CABECERA</b>
                        </button>
                        <button type="button" class="btn btn-danger pl-5 pr-5 float-right d-none"  data-toggle="modal"
                            data-target="#modal">
                            <b>MUESTRA DEL REPORTE</b>
                        </button>
                        <hr>
                    </div>
                </div>
