        ...
        <div class="content-wrapper ">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5 class="m-0 text-dark"><b>TRANSPORTISTAS</b></h5>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Administrador</li>
                                <li class="breadcrumb-item active">Transportista</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid p-2 pt-3">
                <button class="btn btn-info btn-sm" onclick="get_data_new()" data-toggle="modal" data-target="#modal">
                    <b>NUEVO TRANSPORTISTA</b>
                </button>
                <hr>
                <div class="card">
                    <div class="card-body" id="cont-body">
                    </div>
                </div>
            </div>
        </div>
