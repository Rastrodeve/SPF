...
<head>
    ...
    <title>PRODUCTOS-DESPACHO</title>
        ...
        <div class="content-wrapper ">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5 class="m-0 text-dark"><b>PRODUCTOS - DESPACHO</b></h5>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="container-fluid p-2 pt-3">
                <div class="row mb-2">
                    <div class="col-md-12">
                        <button type="button" class="btn btn-outline-secondary pl-5 pr-5" onclick="get_ganchos()" data-toggle="modal"
                            data-target="#modal">
                            <b>ADMINISTRACIÓN DE GANCHOS</b>
                        </button>
                        <hr>
                    </div>
                </div>
