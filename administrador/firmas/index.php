...
<head>
    ...
    <title>ADMINISTRACIÓN DE FIRMAS</title>
    <!-- Font Awesome Icons -->
...
<body class="layout-top-nav text-sm" oncontextmenu="return false">
        ...
        <div class="content-wrapper ">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5 class="m-0 text-dark"><b>ADMINISTRACIÓN DE FIRMAS</b></h5>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
    ...
    <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
        aria-hidden="true">
        <div class="modal-dialog  modal-dialog-scrollable" role="document" id="modal-dialog">
