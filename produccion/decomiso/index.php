        ...
        <div class="content-wrapper ">
            <div class="content-header">
                <div class="container-fluid ">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5 class="m-0 text-dark"><b>DECOMISO</b>
                            <button class="btn btn-sm" id="btn-full-scream" onclick="enviar_tecla()" ><i class="fas fa-expand"></i></button>
                        </h5>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Producción</li>
                                <li class="breadcrumb-item active">Decomiso</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
