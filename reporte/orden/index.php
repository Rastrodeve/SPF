        ...
        <div class="content-wrapper ">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5 class="m-0 text-dark"><b>REPORTE DE ORDEN P.</b></h5>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <div class="form-group clearfix">
                        <div class="icheck-success d-inline mr-4">
                            <input type="radio" name="radioTipo"  id="radioSuccess1" checked value="0">
                            <label for="radioSuccess1">
                                Orde de producción normal
                            </label>
                        </div>
                        <div class="icheck-success d-inline mr-4">
                            <input type="radio" name="radioTipo"  id="radioSuccess2" value="1">
                            <label for="radioSuccess2">
                                Orde de producción emergente
                            </label>
                        </div>
                    </div>
                        <div class="row">
