...
<head>
    ...
    <title>REPORTE ESTADISTICA</title>
        ...
        <div class="content-wrapper ">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5 class="m-0 text-dark"><b>REPORTE DE ESTADISTICAS</b></h5>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Reporte</li>
                                <li class="breadcrumb-item active">estadiscticas</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid p-2" >
                <div class="card">
                    ...
                    <h6>En proceso</h6>
                        ...
                        <hr class="d-none">
                        <div id="cont-table-data" class="d-none">                            
                        </div>
                    </div>
                </div>
            </div>
